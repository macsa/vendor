...
PRODUCT_PACKAGE_OVERLAYS += vendor/macsa/overlay/galaxysmtd
...
#
PRODUCT_PROPERTY_OVERRIDES += \
    ro.modversion=SuperAosp-ST@-Galaxy-S-AW-8.4 \
...
#
PRODUCT_COPY_FILES +=  \
	vendor/macsa/prebuilt/galaxys/etc/super/02ctrlwipe:system/etc/super/02ctrlwipe \
	vendor/macsa/prebuilt/galaxys/etc/super/04modulos:system/etc/super/04modulos \
	vendor/macsa/prebuilt/galaxys/etc/super2/01launcher:system/etc/super2/01launcher \
	vendor/macsa/prebuilt/galaxys/etc/super2/02permisos:system/etc/super2/02permisos \
	vendor/macsa/prebuilt/galaxys/etc/super2/04control:system/etc/super2/04control
